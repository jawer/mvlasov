...
/**.
 * Class IteratorOfIteratorsTest tests iterator for iterators.
...
public class IteratorOfIteratorsTest {
    ...
    /**.
     * Tests that next() doesn't depend on prior hasNext() invocation.
     */
    @Test
    ...
    /**.
     * Tests sequential of  2 hasNext() and next() invocation.
     */
    @Test
    ...
    /**.
     * Test should return false in case of empty iterators.
     */
    @Test
